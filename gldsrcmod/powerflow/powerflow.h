...
// pracherla9 (10/31/2016) --
GLOBAL MATRIXDUMPMETHOD NRMatDumpMethod INIT(MD_ONCE);       // Frequency of saving
GLOBAL char256 filename_md              INIT("ybus.csv");    // YBus           info filename
GLOBAL char256 filename_s2n             INIT("smi2non.csv"); // Sparse-to-NONs info filename
